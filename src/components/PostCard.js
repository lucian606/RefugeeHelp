export default function PostCard(props) {
    ...
    return (
        <div key={index} className="flex justify-between w-11/12 mt-2 mb-2 border-solid border-2 rounded-lg border-gray-600 bg-gray-100 hover:bg-gray-400 overflow-hidden shadow-lg hover:scale-105 transition ease-in-out"
            ...
            </div>
            {
                ...
                <div className="flex justify-between">
                    <span/>
                    <button className="w-11 mr-4" onClick={(e) => deletePost(e, post.id)}>
